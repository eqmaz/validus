...
impl std::str::FromStr for HelloResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        std::result::Result::Ok(HelloResponse {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<HelloResponse>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             ...
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for HelloResponse - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <HelloResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into HelloResponse - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "details" => intermediate_rep.details.push(<models::TradeDetails as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TradeCreateRequest".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeCreateRequest>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeCreateRequest>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeCreateRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeCreateRequest> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeCreateRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeCreateRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::fmt::Display for TradeCreateResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.trade_id.as_ref().map(|trade_id| {
                [
                    "tradeId".to_string(),
                    trade_id.to_string(),
                ].join(",")
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "tradeId" => intermediate_rep.trade_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TradeCreateResponse".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(TradeCreateResponse {
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeCreateResponse>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeCreateResponse>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeCreateResponse - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeCreateResponse> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeCreateResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeCreateResponse - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::fmt::Display for TradeDetails {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.trading_entity.as_ref().map(|trading_entity| {
                [
                    "trading_entity".to_string(),
                    trading_entity.to_string(),
                ].join(",")
            }),
            ...
            self.direction.as_ref().map(|direction| {
                [
                    "direction".to_string(),
                    direction.to_string(),
                ].join(",")
            ...
            self.notional_currency.as_ref().map(|notional_currency| {
                [
                    "notional_currency".to_string(),
                    notional_currency.to_string(),
                ].join(",")
            }),


            self.notional_amount.as_ref().map(|notional_amount| {
                [
            ...
            self.underlying.as_ref().map(|underlying| {
                [
                    ...
                    underlying.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "trading_entity" => intermediate_rep.trading_entity.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "counterparty" => intermediate_rep.counterparty.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "direction" => intermediate_rep.direction.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "notional_currency" => intermediate_rep.notional_currency.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "notional_amount" => intermediate_rep.notional_amount.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "underlying" => return std::result::Result::Err("Parsing a container in this style is not supported in TradeDetails".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "trade_date" => intermediate_rep.trade_date.push(<chrono::DateTime::<chrono::Utc> as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "value_date" => intermediate_rep.value_date.push(<chrono::DateTime::<chrono::Utc> as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "delivery_date" => intermediate_rep.delivery_date.push(<chrono::DateTime::<chrono::Utc> as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "strike" => intermediate_rep.strike.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeDetails>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeDetails>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeDetails - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeDetails> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeDetails as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeDetails - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::fmt::Display for TradeDiff {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            ...
            self.from_version.as_ref().map(|from_version| {
                [
            ...
            self.to_version.as_ref().map(|to_version| {
                [
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "trade_id" => intermediate_rep.trade_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "from_version" => intermediate_rep.from_version.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "to_version" => intermediate_rep.to_version.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "differences" => intermediate_rep.differences.push(<crate::types::Object as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeDiff>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeDiff>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeDiff - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeDiff> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeDiff as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeDiff - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeEvent>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeEvent>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeEvent - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeEvent> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeEvent as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeEvent - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for TradeStatus {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(TradeStatus {
            state: intermediate_rep.state.into_iter().next(),
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<TradeStatus>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TradeStatus>) -> std::result::Result<Self, Self::Error> {
        ...
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TradeStatus - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<HeaderValue> for header::IntoHeaderValue<TradeStatus> {
    ...
    fn try_from(hdr_value: HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TradeStatus as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TradeStatus - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
